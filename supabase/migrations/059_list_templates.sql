-- Product / list templates (Inventory Item List, Change History column layouts).
-- Apply on remote if you see: could not find the table 'public.list_templates' in the schema cache
