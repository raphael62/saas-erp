...
-- Adds sales invoice document tables:
-- - sales_invoices (header)
-- - sales_invoice_lines (line items)
-- NOTE:
--   This script auto-detects the data type of:
--   - public.customers.id
--   - public.sales_reps.id
--   - public.locations.id
--   - public.products.id
--   and creates FK columns with matching types to avoid FK type mismatch.
